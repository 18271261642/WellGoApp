...
public class BannerView extends RelativeLayout {
    ...
    private void setLayout(Context context) {
        ...
        if (mPointContainerBackgroundDrawable == null) {
            mPointContainerBackgroundDrawable = new ColorDrawable(0x00aaaaaa);
        }
        //添加ViewPager
    ...
    private void initViewPager() {
        ...
        //设置ViewPager
        BannerView.FlyPageAdapter adapter = new BannerView.FlyPageAdapter();
    ...
    public void startAutoPlay() {
        startAutoPlay(mAutoPalyTime);
    }

    /**
     * 开始播放
     */
    public void startAutoPlay(long mAutoPalyTime) {
    ...
    private BannerView.OnItemClickListener mOnItemClickListener;
